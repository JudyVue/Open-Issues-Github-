(function(module){
  ...
  helpers.setAutoComplete = function(){
    let searchHistory = [];
    let input = $('input').val();
    searchHistory.push(input);

    localStorage.setItem('issue-search-history', JSON.stringify(searchHistory));
    searchHistory = JSON.parse(localStorage.getItem('issues-search-history'));
